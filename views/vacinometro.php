                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-column flex-lg-row">
                                        ...
                                        <ul class="nav nav-tabs sales-mini-tabs ml-lg-auto mb-4 mb-md-0" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="div5-tab" href="#div5" data-toggle="tab"
                                                    role="tab" aria-controls="div5" aria-selected="true">05 Dias</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="div10-tab" href="#div10" data-toggle="tab"
                                                    role="tab" aria-controls="div10" aria-selected="false">10 Dias</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="div15-tab" href="#div15" data-toggle="tab"
                                                    role="tab" aria-controls="div15" aria-selected="false">15 Dias</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="div5" role="tabpanel"
                                            aria-labelledby="div5-tab">
                                            <?php include_once "tabela05.php" ;?>
                                        </div>
                                        <div class="tab-pane fade" id="div10" role="tabpanel"
                                            aria-labelledby="div10-tab">

											<?php include_once "tabela10.php" ;?>

                                        </div>
                                        <div class="tab-pane fade" id="div15" role="tabpanel"
                                            aria-labelledby="div15-tab">

                                            <?php include_once "tabela15.php" ;?>
