                                            ...
                                            <div class="tab-content tab-content-basic">
                                                ...
                                                <div class="tab-pane fade" id="categorias" role="tabpanel"
                                                    ...
                                                    <div class="alert alert-secondary">
                                                        ...
                                                        <p>
                                                            <?php  
                                                                echo "Temos o total de $doses_total doses aplicadas. <br>";
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <table class="table table-hover">
                                                            <thead>
                                                                <tr>
                                                                    <th>Lote<br>Data</th>
                                                                    <th>Vacina/Fabricante<br>Validade</th>
                                                                    <th>Quantidade</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <strong><?= $row_movimentacao['lote']; ?></strong>
                                                                        <br>
                                                                        <small>Recebimento em
                                                                            <?= date('d/m/Y', strtotime($row_movimentacao['data_recebimento'])); ?></small>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <?= $row_movimentacao['fabricante']; ?> <br>
                                                                        <small> Vencimento em
                                                                        <?= date('d/m/Y', strtotime($row_movimentacao['validade'])); ?></small>
                                                                    </td>
