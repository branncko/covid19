							...
							<div class="col-md-12 grid-margin stretch-card">
								<div class="card">
									<div class="card-body">
										...
										//Verifica link para o processo
										if (empty($link_processo)) {
											echo "Favor digitar o link para o Processo de Dispensa.<br>";
											$erro = 1;
										}

										//Verifica numero
										if (empty($numero_processo)) {
											echo "Favor digitar o número do Processo de Dispensa.<br>";
											$erro = 1;
										}
										
										//Verifica data de publicacao
										if (empty($dia_publicacao)) {
											echo "Favor digitar a data de publicação.<br>";
											$erro = 1;
										}
										
										//Verifica síntese do objeto
										if (empty($sintese)) {
											echo "Favor digitar a síntese do Objeto.<br>";
											$erro = 1;
										}
										...
										if ($erro == 0) {
											...
											include 'includes/insere-dispensa.inc';
										}
										?>
										</code>
										</p>
