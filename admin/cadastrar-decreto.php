					...
					<div class="content-wrapper">
						<div class="row">
							<div class="col-12">
								<div class="page-header">
									<h4 class="page-title">Cadastrar DECRETO</h4>
									<div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap">
										<ul class="quick-links ml-auto list-ticked">
											<li class="text-muted">Insere um novo Decreto.</li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-12 grid-margin stretch-card">
								<div class="card">
									<div class="card-body">
										<h4 class="card-title">INSIRA OS DADOS DO DECRETO</h4>
										<p class="card-description"> <code>Insira os dados nos campos abaixo...</code></p>
											<form class="forms-sample" method="POST" action="verifica-decreto.php">
												...
												<div class="form-group">
													<label for="InputSuspeitos">Número do Decreto</label>
													<input type="text" class="form-control" id="InputNumeroDecreto" name="numero_decreto" placeholder="Insira número e caracteres adicionais">
												</div>
												<div class="form-group">
													<label for="InputData">Data de Publicação</label>
													<input type="date" class="form-control" id="InputDiaPublicacao" name="dia_publicacao" placeholder="Insira a Data de Publicação do Decreto">
												</div>									
												<div class="form-group">
													<label for="InputConfirmados">Detalhes</label>
													<textarea class="form-control" id="InputDetalhes" name="detalhes" placeholder="Insira ementário do Decreto" rows="4"></textarea>
												</div>
