										...
										<p class="card-description"> <code>Utilize ao menos 06 caracteres, incluindo letras e números.</code></p>
											...
											<div class="form-group">
												...
												<div class="form-group">
													...
													<select class="form-control" name="nivel_acesso_id" id="InputNivel" value="<?php echo $_SESSION['nivel_acesso_id']; ?>" disabled>
														<option <?php if($_SESSION['1'] == 'Administrador'){echo 'selected';} ?> value="1">Administrador</option>
														<option <?php if($_SESSION['2'] == 'Saúde'){echo 'selected';} ?> value="2">Saúde</option>
													</select>
												</div>	
