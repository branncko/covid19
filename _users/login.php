<?php
session_start();
$base_url="https://".$_SERVER['SERVER_NAME'].'/covid19';
?>
<!DOCTYPE html>
<html lang="pt-br">
	<head>
		...
		<!-- plugins:css -->
		<link rel="stylesheet" href="<?php echo $base_url ?>/src/assets/vendors/iconfonts/mdi/css/materialdesignicons.min.css">
		<link rel="stylesheet" href="<?php echo $base_url ?>/src/assets/vendors/iconfonts/ionicons/css/ionicons.css">
		<link rel="stylesheet" href="<?php echo $base_url ?>/src/assets/vendors/iconfonts/typicons/src/font/typicons.css">
		<link rel="stylesheet" href="<?php echo $base_url ?>/src/assets/vendors/iconfonts/flag-icon-css/css/flag-icon.min.css">
		<link rel="stylesheet" href="<?php echo $base_url ?>/src/assets/vendors/css/vendor.bundle.base.css">
		<link rel="stylesheet" href="<?php echo $base_url ?>/src/assets/vendors/css/vendor.bundle.addons.css">
		<!-- endinject -->
		<!-- plugin css for this page -->
		<link rel="stylesheet" href="<?php echo $base_url ?>/src/assets/vendors/iconfonts/font-awesome/css/font-awesome.min.css" />
		<!-- End plugin css for this page -->
		<!-- inject:css -->
		<link rel="stylesheet" href="<?php echo $base_url ?>/src/assets/css/shared/style.css">
		<!-- endinject -->
		<!-- Layout styles -->
		<link rel="stylesheet" href="<?php echo $base_url ?>/src/assets/css/demo_1/style.css">
		<!-- End Layout styles -->
		<link rel="shortcut icon" href="<?php echo $base_url ?>/src/assets/images/favicon-pmc.ico" />
	</head>
	<body>
		<div class="container-scroller">
			...
			<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
				<div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
					...
					<img src="<?php echo $base_url ?>/src/assets/images/pmc-logo-mobile.png" alt="Prefeitura de Cruz/CE" /> </a>
				</div>
			...
			<div class="container-fluid page-body-wrapper">
				...
				<nav class="sidebar sidebar-offcanvas" id="sidebar">
					<ul class="nav">
						<li class="nav-item nav-profile">
							<a href="#" class="nav-link">
								<div class="profile-image">
									<img class="img-xs" src="<?php echo $base_url ?>/src/assets/images/stay-at-home.svg" alt="#cruzemcasa">
								</div>
						...
						<li class="nav-item">
							<a class="nav-link" href="<?php echo $base_url ?>/src/pages/internas/index.php">
		...
		<script src="<?php echo $base_url ?>/src/assets/vendors/js/vendor.bundle.addons.js"></script>
		<script src="<?php echo $base_url ?>/src/assets/vendors/js/vendor.bundle.addons.js"></script>
		<!-- endinject -->
