									...
									<div id="laudo" class="card-body">
										<div style="box-shadow: none; border-color: #999" class="card">
											<div class="card-body">
												...
												<div class="row">
													<div class="col-md-12">
														<p style="text-align: center; margin-bottom: 0"><img style="width: 70px" src="../../../assets/images/assinatura_sede2_sarah.png" alt=""><br>Responsável Técnico </br><strong>ENF. Sarah Kelly Alves (COREN 591651)</strong></p>
													</div>
												</div>
											</div>
										</div>
