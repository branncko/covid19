					...
					<div class="content-wrapper">
						<div class="row">
							<div class="col-md-12 grid-margin stretch-card">
								<div class="card">
									<div class="card-body">
										<blockquote class='col-md-12 blockquote blockquote-secondary'>
											<p style="margin-bottom: 0">
												...
												if ($erro == 0) {
													echo "<p style='margin-bottom: 0'><strong>Todos os dados foram digitados corretamente!<br></strong></p>";
													include '../../includes/insere-paciente.inc';
												}
												?>
										</blockquote>
										<button class="btn btn-secondary toolbar-item" onClick="history.go(-1)" ><i style="font-size: 1.24rem" class="mdi mdi-keyboard-backspace text-primary"></i></button>
									</div>
								</div>
							</div>
						</div>
