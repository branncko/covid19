					...
					<div class="content-wrapper">
								...
								<div class="page-header">
									...
									<div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap">
										<ul class="quick-links ml-auto list-ticked">
											<li class="text-muted">Listagem de Pacientes Testados.</li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-12 grid-margin stretch-card">
								<div class="card">
									<div class="card-body">
										<h4 class="card-title">LISTA GERAL DE PACIENTES TESTADOS</h4>
										<p class="card-description"><code>Clique no botão verde para inserir o resultado do Teste Rápido.</code></p>									
											...
											<table id="pacientes" class="table table-stretched">
												...
												<tbody>
													...
													<tr>
														...
														<td class="font-weight-medium"><a class="btn btn-success btn-fw" href="cadastrar-resultado.php?teste_id=<?php echo $row_testes['teste_id']; ?>" role="button"><i class="mdi mdi-file-check"></i> Resultado</a></td>
													</tr>
													<?php } ?>														
												</tbody>
											</table>
