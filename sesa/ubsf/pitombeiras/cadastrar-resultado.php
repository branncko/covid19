													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<select class="form-control" name="ubsf" id="InputUBSF" value="<?php echo $row_testes['ubsf']; ?>" disabled>
																<option disabled <?php if($row_testes['ubsf'] == 'UBSF Belém'){echo 'selected';} ?> value="UBSF Belém">UBSF Belém</option>
																<option disabled <?php if($row_testes['ubsf'] == 'UBSF Caiçara'){echo 'selected';} ?> value="UBSF Caiçara">UBSF Caiçara</option>
																<option disabled <?php if($row_testes['ubsf'] == 'UBSF Cajueirinho'){echo 'selected';} ?> value="UBSF Cajueirinho">UBSF Cajueirinho</option>
																<option disabled <?php if($row_testes['ubsf'] == 'UBSF Córreguinho'){echo 'selected';} ?> value="UBSF Córreguinho">UBSF Córreguinho</option>
																<option disabled <?php if($row_testes['ubsf'] == 'UBSF Paraguai'){echo 'selected';} ?> value="UBSF Paraguai">UBSF Paraguai</option>
																<option <?php if($row_testes['ubsf'] == 'UBSF Pitombeiras'){echo 'selected';} ?> value="UBSF Pitombeiras">UBSF Pitombeiras</option>
																<option disabled <?php if($row_testes['ubsf'] == 'UBSF Poço Doce'){echo 'selected';} ?> value="UBSF Poço Doce">UBSF Poço Doce</option>
																<option disabled <?php if($row_testes['ubsf'] == 'UBSF Preá'){echo 'selected';} ?> value="UBSF Preá">UBSF Preá</option>
																<option disabled <?php if($row_testes['ubsf'] == 'UBSF Sede 1'){echo 'selected';} ?> value="UBSF Sede 1">UBSF Sede 1</option>
																<option disabled <?php if($row_testes['ubsf'] == 'UBSF Sede 2'){echo 'selected';} ?> value="UBSF Sede 2">UBSF Sede 2</option>
																<option disabled <?php if($row_testes['ubsf'] == 'UBSF Sede 3'){echo 'selected';} ?> value="UBSF Sede 3">UBSF Sede 3</option>
																<option disabled <?php if($row_testes['ubsf'] == 'UBSF Tucuns'){echo 'selected';} ?> value="UBSF Tucuns">UBSF Tucuns</option>
															</select>
														</div>
													</div>
												</div>
