							...
							<div class="col-md-12 grid-margin stretch-card">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">TESTE DE ANTICORPOS EM SEPARADO (VERSÃO PARA IMPRESSÃO)</h4>
									...
									<div id="laudo" class="card-body">
										<div style="box-shadow: none; border-color: #999" class="card">
											<div class="card-body">
												...
												<div class="row">
													<div class="col-md-12">
														<p style="text-align: center; margin-bottom: 0"><img style="width: 67px" src="../../../assets/images/assinatura_pitombeiras_camila.png" alt=""><br>Responsável Técnico </br><strong>ENF. Camila Aires Ferreira (COREN 615689)</strong></p>
													</div>
												</div>
											</div>
										</div>
