<?php
	...
	$result_unidade = "SELECT SUM(CASE WHEN ubsf='UBSF Pitombeiras' THEN 1 ELSE 0 END) AS 'total', SUM(CASE WHEN sexo='Masculino' AND ubsf='UBSF Pitombeiras' THEN 1 ELSE 0 END) AS 'masculino', SUM(CASE WHEN sexo='Feminino' AND ubsf='UBSF Pitombeiras' THEN 1 ELSE 0 END) AS 'feminino', SUM(CASE WHEN tipo_teste='teste-totais' AND ubsf='UBSF Pitombeiras' THEN 1 ELSE 0 END) AS 'testes_totais', SUM(CASE WHEN tipo_teste='teste-totais' AND resultado_totais='Reagente' AND ubsf='UBSF Pitombeiras' THEN 1 ELSE 0 END) AS 'reagentes', SUM(CASE WHEN tipo_teste='teste-totais' AND resultado_totais='Não Reagente' AND ubsf='UBSF Pitombeiras' THEN 1 ELSE 0 END) AS 'nao_reagentes', SUM(CASE WHEN tipo_teste='teste-separados' AND ubsf='UBSF Pitombeiras' THEN 1 ELSE 0 END) AS 'testes_separados' FROM testes";
								...
								<div class="page-header">
									...
									<div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap">
										<ul class="quick-links ml-auto list-ticked">
											<li class="text-muted">Edita dados do Pacientes Vinculados</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="col-md-12 grid-margin stretch-card">
								<div class="card">
									<div class="card-body">
											...
											<div class="col-md-2">
												<div class="form-group">
													<div class="form-check">
														...
														<input type="radio" name="situacao" class="form-check-input" value="Cadastrado" <?php if($row_teste['situacao'] == 'Cadastrado'){echo 'checked="Cadastrado"';} ?><?php if($row_teste['situacao'] == 'Liberado'){echo 'disabled=""';} ?>> Cadastrado <i class="input-helper"></i></label>
													</div>
												</div>
											</div>
											<div class="col-md-2">
												<div class="form-group">
													<div class="form-check">
														<label class="form-check-label">
														<input type="radio" name="situacao" class="form-check-input" value="Liberado" <?php if($row_teste['situacao'] == 'Liberado'){echo 'checked="Liberado"';} ?><?php if($row_teste['situacao'] == 'Cadastrado'){echo 'disabled=""';} ?>> Liberado <i class="input-helper"></i></label>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<select class="form-control" name="ubsf" id="InputUBSF">
														<option disabled <?php if($row_teste['ubsf'] == 'UBSF Belém'){echo 'selected';} ?> value="UBSF Belém">UBSF Belém</option>
														<option disabled <?php if($row_teste['ubsf'] == 'UBSF Caiçara'){echo 'selected';} ?> value="UBSF Caiçara">UBSF Caiçara</option>
														<option disabled <?php if($row_teste['ubsf'] == 'UBSF Cajueirinho'){echo 'selected';} ?> value="UBSF Cajueirinho">UBSF Cajueirinho</option>
														<option disabled <?php if($row_teste['ubsf'] == 'UBSF Córreguinho'){echo 'selected';} ?> value="UBSF Córreguinho">UBSF Córreguinho</option>				
														<option disabled <?php if($row_teste['ubsf'] == 'UBSF Paraguai'){echo 'selected';} ?> value="UBSF Paraguai">UBSF Paraguai</option>
														<option <?php if($row_teste['ubsf'] == 'UBSF Pitombeiras'){echo 'selected';} ?> value="UBSF Pitombeiras">UBSF Pitombeiras</option>
														<option disabled <?php if($row_teste['ubsf'] == 'UBSF Poço Doce'){echo 'selected';} ?> value="UBSF Poço Doce">UBSF Poço Doce</option>
														<option disabled <?php if($row_teste['ubsf'] == 'UBSF Preá'){echo 'selected';} ?> value="UBSF Preá">UBSF Preá</option>
														<option disabled <?php if($row_teste['ubsf'] == 'UBSF Sede 1'){echo 'selected';} ?> value="UBSF Sede 1">UBSF Sede 1</option>
														<option disabled <?php if($row_teste['ubsf'] == 'UBSF Sede 2'){echo 'selected';} ?> value="UBSF Sede 2">UBSF Sede 2</option>
														<option disabled <?php if($row_teste['ubsf'] == 'UBSF Sede 3'){echo 'selected';} ?> value="UBSF Preá">UBSF Sede 3</option>
														<option disabled <?php if($row_teste['ubsf'] == 'UBSF Tucuns'){echo 'selected';} ?> value="UBSF Tucuns">UBSF Tucuns</option>
													</select>
												</div>	
											</div>
										</div>
										...
										<div class="separator"></div>
										<button type="submit" class="btn btn-danger mr-2" name="alterar" data-dismiss="modal">Salvar</button>
										</form>
									</div>
								</div>
							</div>
