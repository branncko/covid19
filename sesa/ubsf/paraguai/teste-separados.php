									...
									<div id="laudo" class="card-body">
										<div style="box-shadow: none; border-color: #999" class="card">
											<div class="card-body">
												...
												<div class="row">
													<div class="col-md-12">
														<p style="text-align: center; margin-bottom: 0"><img style="width: 60px" src="../../../assets/images/assinatura_paraguai_raquel.png" alt=""><br>Responsável Técnico </br><strong>ENF. Raquel Mota da Silva (COREN 354788)</strong></p>
													</div>
												</div>
											</div>
										</div>
