									...
									<div id="laudo" class="card-body">
										<div style="box-shadow: none; border-color: #999" class="card">
											<div class="card-body">
												...
												<div class="row">
													<div class="col-md-12">
														<p style="text-align: center; margin-bottom: 0"><img style="width: 90px" src="../../../assets/images/assinatura_belem_beatriz.png" alt=""><br>Responsável Técnico </br><strong>ENF. Beatriz Nascimento Moraes (COREN 537710)</strong></p>
													</div>
												</div>
											</div>
										</div>
