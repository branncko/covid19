									...
									<div id="laudo" class="card-body">
										<div style="box-shadow: none; border-color: #999" class="card">
											<div class="card-body">
												...
												<div class="row">
													<div class="col-md-12">
														<p style="text-align: center; margin-bottom: 0"><img style="width: 60px" src="../../../assets/images/assinatura_poco-doce_dayana.png" alt=""><br>Responsável Técnico </br><strong>ENF. Dayana Mayara Marques Muniz (COREN 408262)</strong></p>
													</div>
												</div>
											</div>
										</div>
