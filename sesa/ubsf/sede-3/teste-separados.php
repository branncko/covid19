									...
									<div id="laudo" class="card-body">
										<div style="box-shadow: none; border-color: #999" class="card">
											<div class="card-body">
												...
												<div class="row">
													<div class="col-md-12">
														<p style="text-align: center; margin-bottom: 0"><img style="width: 58px" src="../../../assets/images/assinatura_sede3_thayna.png" alt=""><br>Responsável Técnico </br><strong>ENF. Thayna Biatriz Farias Muniz (COREN 520507)</strong></p>
													</div>
												</div>
											</div>
										</div>
