...
<html lang="pt-br">
	<head>
		...
		<title>SYSCOVID v2.0 - LOGIN - Prefeitura de Cruz/CE</title>
		<!-- plugins:css -->
		...
		<div class="container-scroller">
			...
			<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
				...
				<div class="navbar-menu-wrapper d-flex align-items-center">
					<ul class="navbar-nav">
						<li class="nav-item font-weight-semibold d-none d-lg-block">SYSCOVID v2.0 - Acesso a Área Administrativa, insira E-mail e Senha conforme cadastro</li>
					</ul>
				</div>
			</nav>
			<!-- partial -->
			<div class="container-fluid page-body-wrapper">
				...
				<nav class="sidebar sidebar-offcanvas" id="sidebar">
					<ul class="nav">
						...
						<li class="nav-item nav-category">Outros sites</li>
						<li class="nav-item">
							<a class="nav-link" href="https://www.cruz.ce.gov.br">
							<i class="menu-icon typcn typcn-document-text"></i>
							<span class="menu-title">Site Oficial do Município</span>
							</a>
						</li>						
						<li class="nav-item">
							<a class="nav-link" href="https://www.cruz.ce.gov.br/covid19">
							<i class="menu-icon typcn typcn-document-text"></i>
							<span class="menu-title">Transparência COVID-19</span>
							</a>
						</li>
					</ul>
				</nav>
							...
							<div class="col-md-12 grid-margin stretch-card">
								<div class="card">
									<div class="card-body">
										...
										<form class="forms-sample" action="../admin/valida.php" method="post">
