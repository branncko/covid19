						...
						<div class="col-md-4 grid-margin stretch-card">
							<div class="card text-white">
								<div class="card-body">
									...
									<p class="card-description"> <code>Inserir Resultados</code></p>
									<div class="media">
										<div class="media-body">
											<p class="card-text"><a class="btn btn-info btn-fw" href="pacientes-resultados.php" role="button"><i class="mdi mdi-check"></i> Listar</a></p>
										</div>
									</div>
								</div>
							</div>
