						...
						<div class="col-md-12">
							<div class="page-header-toolbar">
									<div style="margin-right: 10px" class="dropdown">
										<button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuSizeButton2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Menu de Funções </button>
										<div class="dropdown-menu" aria-labelledby="dropdownMenuSizeButton2" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 35px, 0px);">
											...
											<a class="dropdown-item" href="https://www.governotransparente.com.br/transparencia/1230486/covid/consultarempenho" target="_blank">Novo Paciente</a>
											<a class="dropdown-item" href="https://www.governotransparente.com.br/transparencia/1230486/covid/consultarliqdesporc" target="_blank">Listar Pacientes</a>
										</div>
									</div>
									<div style="margin-right: 10px" class="dropdown">
					...
					<div class="row">
						<div class="col-md-4 grid-margin stretch-card">
							<div class="card text-white">
								<div class="card-body">
									<h4 class="card-title text-black">CADASTRAR NOVO PACIENTE</h4>
									<p class="card-description"> <code>Testes Rápidos (COVID-19)</code></p>
									<div class="media">
										<div class="media-body">
											<p class="card-text"><a class="btn btn-info btn-fw" href="cadastrar-paciente.php" role="button"><i class="mdi mdi-check"></i> Cadastrar</a></p>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-4 grid-margin stretch-card">
							<div class="card text-white">
								<div class="card-body">
									<h4 class="card-title text-black">LISTAR PACIENTES CADASTRADOS</h4>
									<p class="card-description"> <code>Testes Rápidos (COVID-19)</code></p>
									<div class="media">
										<div class="media-body">
											<p class="card-text"><a class="btn btn-info btn-fw" href="pacientes.php" role="button"><i class="mdi mdi-check"></i> Listar</a></p>
										</div>
									</div>
								</div>
							</div>
