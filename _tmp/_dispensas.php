...
<html lang="en">
	<head>
		...
		<title>Prefeitura de Cruz/CE - COVID-19 - DISPENSAS</title>
		<!-- plugins:css -->
									...
									<div class="card-body">
										...
										<div class="table-responsive">
											<table class="table table-stretched">
												...
												<tbody>
													<?php while($mostrar_dispensas = mysqli_fetch_assoc($resultado_dispensas)){ ?>
													<tr>
														<td><a class="btn btn-success btn-fw" href="<?php echo $mostrar_dispensas['link_processo']; ?>" target="_blank" role="button"><i class="mdi mdi-check"></i> Ver Processo</a></td>
														<td class="font-weight-medium"><?php echo $mostrar_dispensas['numero_processo']; ?></td>
														<td class="font-weight-medium"><?php echo date ('d/m/Y', strtotime($mostrar_dispensas['dia_publicacao'])); ?></td>
														<td class="font-weight-medium"><?php echo $mostrar_dispensas['sintese']; ?></td>
														<td class="font-weight-medium"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#detalhes-<?php echo $mostrar_dispensas['dispensa_id']; ?>">+</button></td>
													</tr>
													<!-- Modal detalhes -->
													<div class="modal fade" id="detalhes-<?php echo $mostrar_dispensas['dispensa_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
														<div class="modal-dialog modal-dialog-centered" role="document">
															<div class="modal-content">
																<div class="modal-header">
																	<h4 class="card-title margin-bottom-zero">DECRETO <?php echo $mostrar_dispensas['numero_processo']; ?></h4>
																...
																<div class="modal-body">
																	<p class="card-description margin-bottom-zero">Objeto: <code><?php echo $mostrar_dispensas['detalhes']; ?></code></p>
																</div>
