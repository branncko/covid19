...
<div class="navbar-menu-wrapper d-flex align-items-center">
	<ul class="navbar-nav">
		<li class="nav-item font-weight-semibold d-none d-lg-block">Gerenciamento de Testes Rápidos - COVID-19</li>
	</ul>
	<ul class="navbar-nav ml-auto">
		...
		<div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
			...
			<a class="dropdown-item" href="editar-usuario.php?usuario_id=<?php echo $_SESSION['usuarioId']; ?>">Alterar Senha<i class="dropdown-item-icon ti-dashboard"></i></a>
			<a class="dropdown-item" href="sair.php">Sair<i class="dropdown-item-icon ti-power-off"></i></a>
		</div>
		</li>
	</ul>
