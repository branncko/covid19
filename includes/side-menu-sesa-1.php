					<ul class="nav">
						...
						<li class="nav-item">
							<a class="nav-link" href="painel-pacientes.php">
							<span class="menu-title">Painel</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="cadastrar-paciente.php">
							<span class="menu-title">Cadastrar Paciente</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="pacientes.php">
							<span class="menu-title">Listar Pacientes</span>
							</a>
						</li>						
						<li class="nav-item">
