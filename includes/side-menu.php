					<ul class="nav">
						...
						<li class="nav-item">
							<a class="nav-link" href="boletim.php">
							<i class="menu-icon typcn typcn-shopping-bag"></i>
							<span class="menu-title">Boletim COVID-19</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="vacinometro.php">
							<i class="menu-icon typcn typcn-shopping-bag"></i>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="ui-basic">
								<ul class="nav flex-column sub-menu">
									<li class="nav-item">
										<a class="nav-link" href="decretos.php">Decretos</a>
									</li>
									<li class="nav-item">
									...
									<li class="nav-item">
										<a class="nav-link" href="dispensas.php">Dispensas</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="recomendacoes.php">Recomendações MP/CE</a>
									</li>
								</ul>
							</div>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="educativos.php">
